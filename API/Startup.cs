...
namespace API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ISearchParser, SearchParser>();
            services.AddTransient<ICoreService, CoreService>();
            services.AddTransient<IGoogleEngine, GoogleEngine>();
            services.AddTransient<IBingEngine, BingEngine>();
            services.AddTransient<IEngineQueue, EngineQueue>();
            services.AddCors(opt =>
            {
                opt.AddPolicy("CorsPolicy", policy =>
                {
